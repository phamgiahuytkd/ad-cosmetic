    ...
    <div className="p-3 sm:p-6 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white rounded-sm shadow-md">
        <div className="bg-[#00D5BE] text-white p-4 rounded-t-sm">
          <h2 className="text-lg font-semibold">THÊM THƯƠNG HIỆU</h2>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.name ? 'border-red-500' : 'border-gray-300'}`}
                    disabled={isLoading}
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div
                    className={`border-2 border-dashed rounded-sm p-6 text-center hover:border-gray-400 ${errors.logo ? 'border-red-500' : 'border-gray-300'}`}
                  >
                    {previewUrl ? (
